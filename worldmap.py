...
def InsertRivers(wMap, posX, posY):
    ...
    if P == WATER or P == RIVER[0] or P == RIVER[1] or P == RIVER[2]:
        skip = True
    #Otherwise, check around it.
        ...
        elif dN == RIVER[0] or dN == RIVER[1] or dN == RIVER[3]:
            if P == WATER:
                riverOdds[0] == 0
                riverOdds[1] == 0
                riverOdds[2] == 0
        ...
        elif dNE == RIVER[0] or dNE == RIVER[1] or dNE == RIVER[3]:
                riverOdds[0] += 5
                riverOdds[1] += 3
                riverOdds[2] += 0
        ...
        elif dNW == RIVER[0] or dNW == RIVER[1] or dNW == RIVER[3]:
                riverOdds[0] += 0
                riverOdds[1] += 3
                riverOdds[2] += 5
