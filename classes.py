...
'''+C+'''  _'''+R+W+'''.{ '|'''+C+'''---`'''+R+''' / / \  ''         '''+Z+W+'''oo  '''+C+''',.__'''+R+'''`.      '''+C+'''\.'''+R+'''
'''+C+'''``'''+R+W+''' {  |' '''+R+'''   /.'   \    -     )  '''+Z+W+'''ooO    ,'\`'''+C+'''-.._ `'''+R+'''
'''+W+'''  ,' | '\ '''+R+C+'''^'''+R+'''/ .__.. \.____'''+C+'''='''+R+'''___'''+C+'''=''.'''+R+Z+W+'''OOO  | '''+W+'''.'''+R+'''\    '''+C+'''`:-'''+R+'''
'''+D+'''  ___  '''+R+'''          '''+C+'''`'^'   ';  '' ' ^'''+R+'''    '''+W+'''.'''+Y+'''.'''+R+'''_ -
'''+D+''' /,' `\.  '''+R+'''                     __   '''+D+'''o'''+R+'''.'''+W+'''.|'''+R+Y+''' |'''+I+W+'''|'''+D+'''O'''+R+'''
 '''+C+'''|||'''+R+'''-- '|  '''+C+'''\.        /' '''+R+'''      [__] '''+D+'''o'''+R+'''.'''+W+'''`'''+R+'''--'''+W+'''.'''+R+''' [O'''+Z+D+'''o'''+R+'''  '''+C+'''_,'''+R+'''
 '''+C+'''```-''|+ ,'''+R+'''                   /--\   `[] '''+D+'''o'''+R+'''..'''+D+'''O'''+R+'''  '''+C+'''/ `'''+R+'''
'''+C+'''  `'   '  '``-....--`-------.-.........,-----'' \.'''+R+'''
    ''')
...
'''+G+'''   /\                                      /'''+Z+''' /'''+Z+'''
 ...
 ///'''+Z+'''\ '''+Y+'''/'''+Z+Z+Z+Z+'''_/'''+Z+Z+Z+'''. /////||'''+Z+Z+Z+Z+Z+''' ,///'''+Z+'''_////'''+Z+'''|'''+G+'''///'''+Z+Z+Z+'''
