...
#This page prints the world map with your stronghold's location marked on it
    if screen == "viewMapYourStronghold":
        ...
        PrintLegend()
        print('')
        WorldMapLocation(userStronghold.yCoordinate, userStronghold.xCoordinate, serverMap)
        print('')
        time.sleep(1)
        nothing = input('Continue:')
...
#This page prints the world map with your stronghold's location marked on it
    if screen == "viewMapEnemyStronghold":
        ...
        PrintLegend()
        print('')
        WorldMapLocation(attackStronghold.yCoordinate, attackStronghold.xCoordinate, serverMap)
        print('')
        time.sleep(1)
        nothing = input('Continue:')
...
#This page prints the world map with your stronghold's location marked on it
    if screen == "viewMapCurrentFief":
        ...
        PrintLegend()
        print('')
        WorldMapLocation(attackFief.yCoordinate, attackFief.xCoordinate, serverMap)
        print('')
        time.sleep(1)
        nothing = input('Continue:')
